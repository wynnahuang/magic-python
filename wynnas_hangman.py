...
def drawPickLevelScreen(win):
  ...
  level_1 = Text(Point(220, 450), "LEVEL")
  level_1.setTextColor("purple")
  level_1.setSize(30)
  level_1.draw(win)
  level_1A = Text(Point(280, 450), "1")
  level_1A.setTextColor("orange")
  level_1A.setSize(30)
  level_1A.draw(win)
  level_1B = Text(Point(310, 450), " (Pick 'e' for easys)")
  level_1B.setTextColor("pink")
  level_1B.setSize(10)
  level_1B.draw(win)

  level_2 = Text(Point(220, 350), "LEVEL")
  level_2.setTextColor("cyan")
  level_2.setSize(30)
  level_2.draw(win)
  level_2A = Text(Point(280, 350), "2")
  level_2A.setTextColor("white")
  level_2A.setSize(30)
  level_2A.draw(win)
  level_2B = Text(Point(325, 350), " (Medium)")
  level_2B.setTextColor("green")
  level_2B.setSize(17)
  level_2B.draw(win)

  level_3 = Text(Point(220, 250), "LEVEL")
  level_3.setTextColor("red")
  level_3.setSize(30)
  level_3.draw(win)
  level_3A = Text(Point(280, 250), "3")
  level_3A.setTextColor("maroon")
  level_3A.setSize(30)
  level_3A.draw(win)
  level_3B = Text(Point(315, 250), " (Hard)")
